    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUpTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LonginActivity.this, SignupActivity.class));
                    ...
                    mAuth.signInWithEmailAndPassword(emailStr,passworsStr).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                startActivity(new Intent(LonginActivity.this,HomepageActivity.class));

                                Toast.makeText(LonginActivity.this,"signin succesfuly",Toast.LENGTH_SHORT).show();
                            }
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(LonginActivity.this,e.getMessage(),Toast.LENGTH_SHORT).show();
